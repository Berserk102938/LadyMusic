...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if (!player) return client.sendTime(message.channel, "❌ | **No se reproduce nada en este momento ....**");
        ...
        if (player.playing) return client.sendTime(message.channel, "❌ | ** ¡La música ya se reanudó! **");
        player.pause(false);
        await message.react("✅");
    },
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (player.playing) return client.sendTime(interaction, "❌ | ** ¡La música ya se reanudó! **");
            player.pause(false);
            client.sendTime(interaction, "**⏯ ¡Reanudada!**");
        },
    },
};
